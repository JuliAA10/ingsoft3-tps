...
export default function ProjectDetails() {
  ...
  const totalHours =
    timeEntries?.reduce((acc, entry) => acc + entry.duration / 3600, 0) || 0;
  ...
  return (
    <div className="space-y-6">
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  project and all associated time entries and tasks.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <Tabs defaultValue="time-entries">
        ...
        <TabsContent value="tasks">{/* Tasks table */}</TabsContent>
      </Tabs>
    </div>
  );
}
